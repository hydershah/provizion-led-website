...
const testimonials = [
  ...
  { name: 'Sarah Chen', business: 'Brightside Medical Center', rating: 5, text: 'Professional from start to finish. They handled all permits and installed our channel letters in one day. The illumination quality is exceptional.' },
  { name: 'David Ramirez', business: 'Ramirez Restaurant Group', rating: 5, text: 'Digital menu boards and exterior signage for three locations — delivered on time, on budget, and the results are stunning.' },
];
