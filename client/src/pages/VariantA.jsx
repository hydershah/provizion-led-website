...
export default function VariantA() {
  ...
  return (
    <>
      ...
      {/* ── FOOTER ── */}
      <div className="va-footer" role="contentinfo">
        <div className="container">
          <div className="va-footer-grid">
            ...
            <div className="va-footer-col">
              ...
              <a href={COMPANY.phoneTel} className="va-btn va-btn--outline va-btn--sm">
                <HiPhone /> Call Now
              </a>
            </div>
          </div>
...
function FloatingCTA() {
  ...
  return (
    <motion.a
      href="#contact"
      className="va-floating-cta va-btn va-btn--primary va-btn--glow"
      initial={{ opacity: 0, y: 20 }}
